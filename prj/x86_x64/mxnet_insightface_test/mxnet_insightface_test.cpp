// mxnet_insightface_test.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
void test_camera()
{
	...
	cv::Mat frame;
	frame = cv::imread("E:\\GitCode\\MXNet_Test\\prj\\x86_x64\\mxnet_insightface_test\\test\\vlcsnap-2019-02-21-10h26m46s315.png");
	//while (1)
	{
		//cap >> frame;
...
int main(int argc, char* argv[]) {
	...
	//test_mtcnn();
	std::string path = "E:\\GitCode\\MXNet_Test\\prj\\x86_x64\\mxnet_insightface_test\\芜湖市第二中学高中一年级(2)班";
